		...
		<div class="card p-8">
			{#if signupDisabled}
				...
				<div class="text-center py-4">
					...
					<h2 class="text-xl font-semibold text-gray-900 mb-2">We're in Closed Beta</h2>
					<p class="text-gray-600 mb-6">
						New signups are currently limited. Join our waitlist to be notified when access becomes available.
					</p>
					<button onclick={goToWaitlist} class="btn-primary w-full">
						Join the Waitlist
					</button>
