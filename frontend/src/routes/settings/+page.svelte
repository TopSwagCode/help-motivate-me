...
<div class="bg-warm-cream">
	<main class="max-w-3xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
		<h1 class="text-xl sm:text-2xl font-bold text-cocoa-800 mb-4 sm:mb-6">{$t('settings.title')}</h1>
		...
		{:else}
			<!-- Tab Navigation -->
			<div class="border-b border-primary-100 mb-4 sm:mb-6 -mx-3 sm:mx-0 px-3 sm:px-0">
