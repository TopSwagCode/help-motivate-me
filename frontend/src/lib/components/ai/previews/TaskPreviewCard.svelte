...
<div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
	...
	{#if editingTitle}
		<input
			...
			class="w-full text-lg font-semibold text-gray-900 bg-white border border-blue-300 rounded px-2 py-1 outline-none focus:ring-2 focus:ring-blue-400"
			autofocus
		/>
	{:else}
		<button
			...
			class="text-lg font-semibold text-gray-900 hover:bg-blue-100 rounded px-1 -mx-1 transition-colors text-left w-full"
	...
	{#if editingDescription}
		<textarea
			...
			class="w-full text-gray-600 mt-1 text-sm bg-white border border-blue-300 rounded px-2 py-1 outline-none focus:ring-2 focus:ring-blue-400 resize-none"
			rows="2"
			autofocus
		></textarea>
	{:else}
		<button
			...
			class="text-gray-600 mt-1 text-sm hover:bg-blue-100 rounded px-1 -mx-1 transition-colors text-left w-full {!localData.description ? 'italic text-gray-400' : ''}"
			title={$t('ai.preview.clickToEdit')}
		>
