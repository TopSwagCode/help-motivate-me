		...
		<div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
			<div class="flex flex-col sm:flex-row items-center justify-between gap-2 py-2.5 sm:py-2">
				<div class="flex items-center gap-2 text-center sm:text-left">
					<div class="hidden sm:flex items-center justify-center w-6 h-6 bg-warm-paper/20 rounded-full flex-shrink-0">
				...
				<button
					...
					class="flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-medium bg-warm-paper/10 hover:bg-warm-paper/20 
					       rounded-2xl transition-colors duration-300 flex-shrink-0 whitespace-nowrap"
