...
public class MilestoneService : IMilestoneService
{
    ...
    public async Task<List<UserMilestoneResponse>> RecordEventAsync(Guid userId, string eventType, object? metadata = null)
    {
    ...
    public async Task<UserStatsResponse> GetUserStatsAsync(Guid userId)
    {
        ...
        if (stats == null)
        {
            return new UserStatsResponse(0, 0, 0, 0, 0, 0, null, null);
        }
    ...
    private async Task<List<UserMilestoneResponse>> EvaluateMilestonesAsync(Guid userId, string eventType, UserStats stats)
    {
    ...
    private static UserMilestoneResponse ToResponse(UserMilestone um) => new(
        um.Id,
