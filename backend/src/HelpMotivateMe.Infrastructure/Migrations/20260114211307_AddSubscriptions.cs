        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolarSubscriptionId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    PolarCustomerId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_PolarSubscriptionId",
                table: "subscriptions",
                column: "PolarSubscriptionId",
                unique: true);
