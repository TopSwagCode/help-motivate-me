...
public class DanishPushNotificationMessages : IPushNotificationMessages
{
    ...
    public string MorningCommitmentBody =>
        "Tag et øjeblik og forpligt dig til én lille handling, der beviser din identitet.";
    ...
    public string AfternoonReminderBody =>
        "Du har ikke fuldført din daglige forpligtelse endnu. Der er stadig tid til at vise hvem du vil være.";
    ...
    public string EveningReflectionBody =>
        "Tag et øjeblik til at reflektere over din dag og fejre enhver fremgang, uanset hvor lille.";
}